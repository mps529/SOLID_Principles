...
//OCP Open Close Principle + Specification DP
...
class Product {
 ...
 //old filter, need to edit it any time a filter changes
class ProductFilter {
...
//new filter, uses generics to be reusable for any new filters
...
//combinator for two specifications
...
class DemoOCP {
    public static void main(String[] args) {
        ...
        Product boat = new Product("Boat", Color.BLUE, Size.YUGE);

        List<Product> products = List.of(apple, tree, house);

        /*uses the old filter, which break OC Principle*/
        ProductFilter pf = new ProductFilter();
        System.out.println("Green products (Old):");
        pf.filterByColor(products, Color.GREEN).forEach(p -> System.out.println(" - "+ p.name + " is green"));

        /*adheres to the open close principle using the generic new filter*/
